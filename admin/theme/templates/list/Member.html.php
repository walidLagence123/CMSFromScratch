            ...
            <?php 
                if(!empty($data_list)){
                    foreach($data_list as $k=>$v){
                        echo '<tr>';
                        echo '<td>'.$data_list[$k]['id_member'].'</td>';
                        echo '<td>'.$data_list[$k]['lastname'].'</td>';
                        echo '<td>'.$data_list[$k]['firstname'].'</td>';
                        echo '<td>'.$data_list[$k]['city'].'</td>';
                        echo '<td>'.$data_list[$k]['zip_code'].'</td>';
                        echo '<td>'.$data_list[$k]['country'].'</td>';
